...
#the class extention below should not be needed but I can't get the KMK extentions to trigger on these events, please advise if you can get it to work 
class KeyTracker(KMKKeyboard): #hijack the keyboards process key function to allow the UI to respond to keystrokes
...
#Change the pins below if you handwired your board. You can leave them be if you had the pcb made.
